...
SUB_PATH = os.environ.get('SUB_PATH', 'a06c168b5b0e')           # 订阅token,默认sub，例如：https://www.google.com/sub
UUID = os.environ.get('UUID', 'a06c168b-5b0e-4e85-9342-73b18af1f4c0')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'ori.drinkwind.elementfx.com')        # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiODllYjAxMDBmMjFmZmJkYWRjZTViNDc5NjJiNTlkYjAiLCJ0IjoiMWYzMzFiOWYtMmZjNi00ZTY2LThhYjEtNDI5NzI4MDRjYjUwIiwicyI6Ik5qazNNV016TXpjdE16UmxNeTAwWXpreExUa3dNV1l0T0dOa01tRTVaR1ZoWlRObSJ9')            # Argo固定隧道密钥,留空即使用临时隧道
...
NAME = os.environ.get('NAME', 'sub')                   # 节点名称
...
PORT = int(os.environ.get('SERVER_PORT') or os.environ.get('PORT') or 30274) # 订阅端口，如无法订阅，请手动修改为分配的端口
